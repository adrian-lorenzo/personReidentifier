...
from modules.embeddingGenerators.abd.torchreid.components import branches
from modules.embeddingGenerators.abd.torchreid.components.shallow_cam import ShallowCAM
...
class MultiBranchResNet(branches.MultiBranchNetwork):
    ...
    def _get_common_branch(self, backbone):
        return ResNetCommonBranch(self, backbone)

    def _get_middle_subbranch_for(self, backbone, last_branch_class):
        return ResNetDeepBranch(self, backbone)
...
class MultiBranchMGNLikeResNet(branches.MultiBranchNetwork):
    ...
    def _get_middle_subbranch_for(self, backbone, last_branch_class):
        return ResNetMGNLikeDeepBranch(self, backbone)
...
def resnet50(num_classes, **kw):
    ...
    return MultiBranchResNet(backbone, num_classes)
