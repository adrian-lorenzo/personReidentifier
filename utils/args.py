...
def buildArgumentParser():
    ...
    Implementation with CLI interface of the work done for the degree final project "Combinación de apariencia e información de contexto para la re-identificación en competiciones deportivas".
    """)

    argparser.add_argument("--silent", action='store_false', help="Runs the program in silent mode (no verbose).")
    ...
    argparser.add_argument("--detectionThreshold", type=float, metavar="threshold_float",
                           help="Specifies the detection threshold. Default Value: 0.8.")
    ...
    argparser.add_argument("--windowSize", type=int, metavar="integer", help="Window size for time heuristic. Default value: 30.")
    argparser.add_argument("--shiftSize", type=int, metavar="integer", help="Shift size for time heuristic. Default value: 1.")
    argparser.add_argument("--shiftProp", type=float, metavar="float", help="Shift proportion for time heuristic. Default value: 1.")
    ...
    argparser.add_argument("--fps", type=int, metavar="integer", help="FPS for space heuristic. Default value: 5.")
    argparser.add_argument("--timeout", type=int, metavar="float", help="Timeout for space heuristic. Default value: 10.")

    argparser.add_argument("--video", type=str, metavar="video_path", help="Runs system with specified video file.")
